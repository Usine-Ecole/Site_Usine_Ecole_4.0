                        ...
                        <div class="col-12 col-xl-7 col-lg-8 col-lg-9">
                            <div class="card">
                                <div class="card-body p-4">
                                    <!-- Register Form -->
                                    <form action="<?= ROOT_URL ?>admin/add-post-logic" class="form-sign contact-form needs-validation p-3" enctype="multipart/form-data" method="POST" novalidate>
                                        <h1 class="h2" style="color: #24262b;">Ajouter une actualité</h1>
                                        <hr>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea rows="10" name="body" class="form-control form-control-lg" value="<?= $body ?>" placeholder="Description de l'actualité"></textarea>
                                                </div>
                                            </div>
