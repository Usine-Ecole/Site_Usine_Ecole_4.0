                        ...
                        <div class="col-12 col-xl-7 col-lg-8 col-lg-9">
                            <div class="card">
                                <div class="card-body p-4">
                                    <!-- Register Form -->
                                    <form action="<?= ROOT_URL ?>admin/add-user-logic" class="form-sign contact-form needs-validation p-3" enctype="multipart/form-data" method="POST" novalidate>
                                        <h1 class="h2" style="color: #24262b;">Ajouter un utilisateur</h1>
                                        <hr>
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-lg" id="txtFirstName3" name="nom" value="<?= $nom ?>" placeholder="Nom">
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-lg" id="txtLastName3" name="prenom" value="<?= $prenom ?>" placeholder="Prénom">
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="mb-3">
                                                    <label for="txtUsername3" class="form-label">Nom d'utilisateur<span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control form-control-lg" id="txtUsername3" name="username" value="<?= $username ?>" placeholder="Nom d'utilisateur" required>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="mb-3">
                                                    <label for="txtEmail3" class="form-label">Email<span class="text-danger">*</span></label>
                                                    <input class="form-control form-control-lg" id="txtEmail3" type="email" name="email" value="<?= $email ?>" placeholder="Email">
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="mb-3">
                                                    <label for="txtPassword3" class="form-label">Mot de passe<span class="text-danger">*</span></label>
                                                    <input class="form-control form-control-lg" id="txtPassword3" type="password" name="createpassword" value="<?= $createpassword ?>" placeholder="Crée un mot de passe">
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="mb-3">
                                                    <label for="txtRetypePassword3" class="form-label">Confirmez votre mot de passe<span class="text-danger">*</span></label>
                                                    <input class="form-control form-control-lg" id="txtRetypePassword3" type="password" name="confirmpassword" value="<?= $confirmpassword ?>" placeholder="Confirme votre mot de passe">
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <label for="txtListUserRole" class="form-label">Liste déroulante des rôles utilisateurs</span></label>
                                                <select name="userrole" class="form-control form-control-lg" id="txtListUserRole">
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="mb-3">
                                                    <label for="avatar" class="form-label">Ajouter une image<span class="text-danger">*</span></label>
