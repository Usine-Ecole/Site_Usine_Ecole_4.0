                        ...
                        <div class="col-12 col-xl-7 col-lg-8 col-lg-9">
                            <div class="card">
                                <div class="card-body p-4">
                                    <!-- Register Form -->
                                    <form action="<?= ROOT_URL ?>admin/edit-category-logic" class="form-sign contact-form needs-validation p-3" enctype="multipart/form-data" method="POST" novalidate>
                                        <h1 class="h2" style="color: #24262b;">Modifier une categorie</h1>
                                        <hr>
                                        <!-- Register -->
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="mb-3">
                                                    <label for="txtFirstName3" class="form-label">Titre de la catégorie<span class="text-danger">*</span> </label>
                                                    <input type="text" class="form-control form-control-lg" id="txtFirstName3" name="title" value="<?= $category['title'] ?>" placeholder="Titre">

                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label for="Description" class="form-label">Description de la catégorie<span class="text-danger">*</span></label>
                                                    <textarea rows="4" name="description" class="form-control form-control-lg" placeholder="Description"><?= $category['description'] ?></textarea>
                                                </div>
                                        </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-6">
                                    <ul class="list-unstyled footer-list">
                                        ...
                                        <li>
                                            <a href="../soft" class="k-hover">Soft-skills</a>
                                        </li>
                                        <li>
