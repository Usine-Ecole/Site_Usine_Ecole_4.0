                        ...
                        <div class="col-12 col-xl-7 col-lg-8 col-lg-9">
                            <div class="card">
                                <div class="card-body p-4">
                                    <!-- Register Form -->
                                    <form action="<?= ROOT_URL ?>admin/edit-user-logic" class="form-sign contact-form needs-validation p-3" enctype="multipart/form-data" method="POST" novalidate>
                                        <h1 class="h2" style="color: #24262b;">Modifier un utilisateur</h1>
                                        <hr>
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-lg" id="txtFirstName3" name="nom" value="<?= $user['nom'] ?>" placeholder="Nom">
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-lg" id="txtLastName3" name="prenom" value="<?= $user['prenom'] ?>" placeholder="Prénom">
                                                </div>
                                            </div>
