                ...
                <div class="heading-page-swiper-box">
                    ...
                    <div class="swiper heading-page-swiper">
                        ...
                        <div class="title-page title-page-absolute light-content">
                            <div class="container">
                                <div class="pd-left-right-50px" data-aos-delay="300" data-aos="fade-up">
                                    <div class="info-box-title heading heading-sub">
                                        <span class="sub-title line-before">Usine-Ecole 4.0</span>
                                        <h1 class="title title-lg fw-light">Liste des catégories</h1>
                            ...
                            <tbody>
                                <?php while ($category = mysqli_fetch_assoc($categories)) : ?>
                                    <tr>
                                        ...
                                        <td><a href="<?= ROOT_URL ?>admin/edit-category?id=<?= $category['id'] ?>" class="btn btn-success">Modifier</a></td>
                                        <td><a href="<?= ROOT_URL ?>admin/delete-category?id=<?= $category['id'] ?>" class="btn btn-danger">Supprimer</a></td>
                                    </tr>
                                <?php endwhile ?>
                            </tbody>
                        </table>
                    <?php else : ?>
                        <div class="alert__message error row justify-content-center" style="width: 60%; margin: 30px auto;"><?= "Aucune catégorie trouvé " ?>
                        </div>
                    <?php endif ?>
                </main>
            </div>
