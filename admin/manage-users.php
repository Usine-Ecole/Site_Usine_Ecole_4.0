                            ...
                            <div class="container">
                                <div class="pd-left-right-50px" data-aos-delay="300" data-aos="fade-in">
                                    <div class="info-box-title heading heading-sub">
                                        ...
                                        <h1 class="title title-lg fw-light">Liste des utilisateurs</h1>
        ...
        <section id="news" class="dashboard clearfix news-home-box pd-bottom-1000 bg-light pd-left-right-50px">
            ...
            <div class="container dashboard__container">
                ...
                <main class="container table-responsive">
                            ...
                            <tbody>
                                <?php while ($user = mysqli_fetch_assoc($users)) : ?>
                                    <tr>
                                        ...
                                        <td><a href="<?= ROOT_URL ?>admin/edit-user?id=<?= $user['id'] ?>" class="btn btn-success">Modifier</a></td>
                                        <td><a href="<?= ROOT_URL ?>admin/delete-user?id=<?= $user['id'] ?>" class="btn btn-danger">Supprimer</a></td>
                    ...
                    <?php else : ?>
                        <div class="alert__message error row justify-content-center" style="width: 60%; margin: 30px auto;"><?= "Aucun utilisateur trouvé " ?>
                        </div>
                    <?php endif ?>
                </main>
            </div>
