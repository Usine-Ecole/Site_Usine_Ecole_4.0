                        ...
                        <div class="col-12 col-xl-5 col-lg-6 col-lg-7">
                            <div class="card">
                                <div class="card-body p-4">
                                    ...
                                    <form action="reset_password.php" class="contact-form needs-validation p-3" method="post" novalidate>
                                        <?php
                                        ...
                                        ?>
                                        <div class="mb-3">
                                            <label for="txtResetEmail" class="form-label">Adresse e-mail<span class="text-danger">*</span></label>
                                            <input class="form-control form-control-lg" type="email" id="txtResetEmail" name="reset_email" placeholder="Adresse e-mail" required>
                                        </div>
                                        <div class="mt-5">
                                            <button type="submit" name="submit_reset" class="btn btn-lg btn-ht-primary btn-send pe-4 ps-4" id="btnSubmitReset">
