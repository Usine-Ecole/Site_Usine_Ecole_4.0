                        ...
                        <div class="col-12 col-xl-5 col-lg-6 col-lg-7">
                            <div class="card">
                                <div class="card-body p-4">
                                    <!-- Form Login -->
                                    <form action="<?= ROOT_URL ?>login-adherant-projet-logic" class="contact-form needs-validation p-3" enctype="multipart/form-data" method="post" novalidate>
                                        ...
                                        <div class="mb-3">
                                            <p>Vous voulez avoir accès à nos projets ?<a href="contact"> Contactez-nous</a></p>
                                        </div>
                                        <div class="mt-5">
