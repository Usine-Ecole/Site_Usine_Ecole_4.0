                        ...
                        <div class="col-12 col-xl-5 col-lg-6 col-lg-7">
                            <div class="card">
                                <div class="card-body p-4">
                                    <!-- Form Login -->
                                    <form action="<?= ROOT_URL ?>login_soft_logic" class="contact-form needs-validation p-3" enctype="multipart/form-data" method="post" novalidate>
                                        <h1 class="h2">Connexion soft-skills</h1>
                                        <hr>
                                        <?php
                                        ...
                                        <div class="mb-3">
                                            <p>Vous n'avez pas de compte ?<a href="register_soft"> Inscrivez-vous</a></p>
                                            <a href="<?= ROOT_URL ?>forgot_password" class="forgot-password-link">Mot de passe oublié ?</a>
                                        </div>
                                        <div class="mt-5">
