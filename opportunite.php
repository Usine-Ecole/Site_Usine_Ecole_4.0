...
<body>
    ...
    <main id="main">
    <section id="tours" class="clearfix tours-box  bg-transparent-top pd-top-600 pd-bottom-1000">
                    ...
                    <div class="pd-right-30pc mb-5" data-aos-delay="300" data-aos="fade-in">
                        <div class="clearfix">
                            <div class="heading heading-sub">
                                ...
                                <h1 class="title title-lg fw-light" style="color: white;">Nos Opportunités</h1>
                            </div>
                            <div class="breadcrumb-box">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="/" class="">Accueil</a></li>
                                        <li class="breadcrumb-item"><a href="#" class="">Nous connaitre</a></li>
                                        <li class="breadcrumb-item active" aria-current="page" style="color: white;">Nos Opportunités</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
            ...
            <div class="tour-list">
                <div class="container">
                    <div class="tour-list-container">
                        <div class="row grid-tour-2col g-0 g-lg-5">
                            <div class="col-12 col-xl-4 col-lg-6 grid-sizer"></div>
                            

                            <div class="col-12 col-xl-4 col-lg-6 grid-item mb-5 mb-lg-0">
                                <figure class="category-item">
                                    <a href="#" class="category-item-container" data-aos-delay="300" data-aos="fade-in" data-bs-toggle="modal" data-bs-target="#mdlDetailAirbus">
                                        <img src="./assets/images/Opportunite/Airbus.jpg" srcset="./assets/images/Opportunite/t1@2x.jpg 2x" alt="">
                                        <span class="category-item-overlay"></span>
                                        <div class="category-item-caption">
                                            <h2 class="category-item-title">Airbus </h2>
                                            <span class="category-item-detail">
                            ...
                            <div class="col-12 col-xl-4 col-lg-6 grid-item mb-5 mb-lg-0">
                                <figure class="category-item">
                                    <a href="#" class="category-item-container" data-aos-delay="300" data-aos="fade-in" data-bs-toggle="modal" data-bs-target="#mdlDetailAirbus">
                                        <img src="./assets/images/Opportunite/groupe lpf.JPG" srcset="./assets/images/Opportunite/t2@2x.jpg 2x" alt="">
                                        <span class="category-item-overlay"></span>
                                        <div class="category-item-caption">
                                            <h2 class="category-item-title">Groupe LPF </h2>
                                            <span class="category-item-detail">
                                                <span>En savoir plus</span>
                                                <i class="ficon ficon-thin-circle-arrow-left"></i>
                                            </span>
                     ...
                     <div class="modal fade" id="mdlDetailAIrbus" tab/="-1" aria-hidden="true">
