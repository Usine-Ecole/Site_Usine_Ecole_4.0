...
<body>
    ...
    <main id="main">
        <!-- TOURS -->
        <!-- TOURS -->
        <section id="single-post" class="clearfix single-post-box pd-left-right-50px bg-transparent-top pd-top-600 pd-bottom-1000">
                    ...
                    <div class="pd-right-30pc mb-5" data-aos-delay="300" data-aos="fade-up">
                        <div class="clearfix">
                            <div class="heading heading-sub">
                                <span class="sub-title line-before"><?= date("M d, Y - H:i", strtotime($post['date_time'])) ?></span>
                                <h1 class="title title-lg fw-light" style="color: #fff;"><?= $post['title'] ?></h1>
                            </div>
                            <div class="breadcrumb-box">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="/" class="k-hover">Accueil</a></li>
                                        <li class="breadcrumb-item"><a href="actu" class="k-hover">Actualités</a></li>
                                        <li class="breadcrumb-item active" aria-current="page" style="color: #fff">Actualité choisi</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="detail-post-container">
                        <div class="row g-0 g-xl-5">
                            <div class="col-12 col-xl-8">
                                <!-- Thumbnail -->
                                <figure class="img-thumb" data-aos-delay="300" data-aos="fade-up">
                                    <img src="./assets/images/actu/<?= $post['thumbnail'] ?>" srcset="assets/img/news/n4@2x.jpg 2x" alt="" class="img-fluid">
                                </figure>
                                <!-- Thumbnail -->
                                <!-- Meta -->
                                ...
                                <!-- Meta -->
                                <!-- Content -->
                                <div class="content-post" data-aos-delay="300" data-aos="fade-up" style="color: #fff;">
                                    <p><?= $post['body'] ?></p>
                                </div>
