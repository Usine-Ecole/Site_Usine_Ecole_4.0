                        ...
                        <div class="col-12 col-xl-8 col-lg-9 col-lg-10">
                            <div class="card">
                                <div class="card-body p-4">
                                    <!-- Register Form -->
                                    <form action="<?= ROOT_URL ?>register_soft_logic" class="contact-form needs-validation p-3" enctype="multipart/form-data" method="post" novalidate>
                                        <h1 class="h2">Accès aux soft-skills : inscription</h1>
                                        <hr>
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input  type="text" class="form-control form-control-lg" id="txtFirstName3" name="name" value="<?= $name ?>" placeholder="Nom/Prénom" required>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="tel" class="form-control form-control-lg" id="txtLastName3" name="phone" value="<?= $phone ?>" placeholder="Téléphone" required>
                                                    <div class="invalid-feedback">
