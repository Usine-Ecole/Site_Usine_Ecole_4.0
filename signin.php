...
<body>
    ...
    <main id="main">
        <!-- LOGIN -->
        <!-- LOGIN -->
        <section id="login" class="clearfix login-box pd-left-right-50px bg-light pd-top-600 pd-bottom-600">
            <div class="login">
                        ...
                        <div class="col-12 col-xl-4 col-lg-6 col-lg-8">
                            <div class="card">
                                <div class="card-body p-4">
                                    <!-- Form Login -->
                                    <form action="<?= ROOT_URL ?>signin-logic" class="form-sign contact-form needs-validation p-3" method="POST" novalidate>
                                        <h1 class="h2" style="color: #24262b;">Connexion</h1>
                                        <hr>
                                        <?php
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-6">
                                                <div class="mb-3">
                                                    <label for="txtUsername2" class="form-label">Nom d'utilisateur ou email<span class="text-danger">*</span></label>
                                                    <input class="form-control form-control-lg" type="text" id="txtUsername2" name="username_email" value="<?= $username_email ?>" placeholder="Nom d'utilisateur ou email">
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="mb-3">
