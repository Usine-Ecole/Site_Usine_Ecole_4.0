                        ...
                        <div class="col-12 col-xl-7 col-lg-8 col-lg-9">
                            <div class="card">
                                <div class="card-body p-4">
                                    <!-- Register Form -->
                                    <form action="<?= ROOT_URL ?>signup-logic" class="form-sign contact-form needs-validation p-3" enctype="multipart/form-data" method="POST" novalidate>
                                        <h1 class="h2" style="color: #24262b;">S'inscrire</h1>
                                        <hr>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control form-control-lg" id="txtEmail3"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-6">
                                    ...
                                    <a href="soft" class="k-hover"><span>Soft-Skills</span></a>
                                        ...
                                        <li>
                                            <a href="contact" class="k-hover">Restaurant</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
