                        ...
                        <nav id="navbar" class="navbar">
                            <ul>
                                ...
                                <li class="dropdown has-icon">
                                    <a href="logout_soft.php" class="k-hover">
            ...
            <div class="container">
                <div class="pd-right-95px">
                    <div class="heading heading-sub" data-aos-delay="300" data-aos="fade-up">
                        ...
                        <h2 class="title title-lg fw-light d-flex justify-content-center" style="color: #fff;">Testez vos soft-skills</h2>
                    </div>
                    <br>
                            ...
                            <div>
                                <tbody>
                                    ...
                                    <div data-question="1" class="quiz__step--1 quiz__step--current quiz__step">
                                        ...
                                        <tr>
                                            <td> <a data-bs-toggle="modal" data-bs-target="#mdlDetail4" style="color: #c62828; cursor: pointer;">Apprendre à apprendre</a> </td>
                                        ...
                                        <tr>
                                            <td> <a data-bs-toggle="modal" data-bs-target="#mdlDetail5" style="color: #c62828; cursor: pointer;">Contrôle de qualité</a></td>
                                            <td class="label-check">
                                                <select id="app" class="answer__label" name="apprentissage[]" required>
                                                    <option value="" disabled selected>Choisir</option>
                                                    <option value="<?php echo $acquis ?>">Acquis</option>
                                    ...
                                    <div data-question="2" class="quiz__step--2 quiz__step">
                                        ...
                                        <tr>
                                            <td> <a data-bs-toggle="modal" data-bs-target="#mdlDetail6" style="color: #0984e3; cursor: pointer;">Éthique</a></td>
                                        ...
                                        <tr>
                                            <td><a data-bs-toggle="modal" data-bs-target="#mdlDetail7" style="color: #0984e3; cursor: pointer;">Motivation intrinsèque</a></td>
                                            <td class="label-check">
                                                <select id="intra" class="answer__label" name="intrapersonnelles[]" required>
                                                    <option value="" disabled selected>Choisir</option>
                                                    <option value="<?php echo $acquis ?>">Acquis</option>
                                    ...
                                    <div data-question="5" class="quiz__step--5 quiz__step">
                                        ...
                                        <tr>
                                            <td><a data-bs-toggle="modal" data-bs-target="#mdlDetail8" style="color: #f0932b; cursor: pointer;">Assertivité</a></td>
                                            <td class="label-check">
                                                <select id="inter" class="answer__label" name="interpersonnelles[]" required>
                                                    <option value="" disabled selected>Choisir</option>
                                                    <option value="<?php echo $acquis ?>">Acquis</option>
